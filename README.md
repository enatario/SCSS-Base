...
- **[Base](#base)** files are local and custom-written dependencies for your scss. Base files include many global classes, helpers, and variables you'll need for your project (I've also seen this called `globals` instead of `base`).
